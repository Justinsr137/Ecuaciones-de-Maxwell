...
| 4 | Ley de Ampère-Maxwell, ∇×B = μ₀J + μ₀ε₀∂E/∂t | (c) Pulso electromagnético propagándose (también sirve de ejemplo de la sección 7, "Full-system integration") | [`ampere_maxwell.py`](./ampere_maxwell.py) | 
